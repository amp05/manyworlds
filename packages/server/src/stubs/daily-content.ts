    ...
    blessings: {
      player: [
        ...
        },
        {
          ...
          text: 'The first time you would be reduced to 0 HP, you instead survive with 1 HP and gain 3 turns of invulnerability. This can only trigger once.',
          flavor: 'Death reaches out — but not yet.',
          blessingParams: { nTurns: null, hpThreshold: null },
          visualEffect: 'shadow',
        },
        {
